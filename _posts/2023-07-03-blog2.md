...
> **Disclaimer**: I don't have a degree in Computer Science, nor am I an expert coder. I often cross-check my code with ChatGPT and other large language models (LLMs). While the code may be quite generic, it works and might be useful for someone, so I'm sharing it here.
